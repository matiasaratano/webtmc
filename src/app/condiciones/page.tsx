          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none space-y-6">
              <p className="text-lg text-muted-foreground tracking-tight">
                ...
                <b>A partir del 1 DE OCTUBRE solamente se podrá abonar 1 Pago Total de $200.000 al contado al momento de la inscripción.</b>
              ...
              <p className="text-lg text-muted-foreground tracking-tight">
                ...
                <b>A partir del 1 DE OCTUBRE solamente se podrá abonar 1 Pago total de $100.000 al contado al momento de la inscripción.</b>
