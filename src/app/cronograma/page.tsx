            ...
            <div className="overflow-x-auto">
              <table className="min-w-full border border-gray-300 rounded-lg">
                ...
                <tbody>
                  ...
                  <tr><td className="px-4 py-2 border">9A</td><td className="px-4 py-2 border">Daysi Linares</td><td className="px-4 py-2 border">Iniciación a la moldería cerámica</td><td className="px-4 py-2 border">X</td><td className="px-4 py-2 border"></td><td className="px-4 py-2 border">X</td><td className="px-4 py-2 border"></td></tr>
                  <tr><td className="px-4 py-2 border">9B</td><td className="px-4 py-2 border">Daysi Linares</td><td className="px-4 py-2 border">Iniciación a la moldería cerámica</td><td className="px-4 py-2 border"></td><td className="px-4 py-2 border">X</td><td className="px-4 py-2 border"></td><td className="px-4 py-2 border">X</td></tr>
