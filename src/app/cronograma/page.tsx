            ...
            <div className="overflow-x-auto">
              <table className="min-w-full border border-gray-300 rounded-lg">
                ...
                <tbody>
                  ...
                  <tr><td className="px-4 py-2 border">18</td><td className="px-4 py-2 border">Antonio Paez - Gabriel Giancalepore</td><td className="px-4 py-2 border">Esmaltes cerámicos del pasado</td><td className="px-4 py-2 border">X</td><td className="px-4 py-2 border">X</td><td className="px-4 py-2 border"></td><td className="px-4 py-2 border">X</td></tr>
                  ...
                  <tr><td className="px-4 py-2 border">22</td><td className="px-4 py-2 border">Gabriela Lopez Osornio - Alejandro Pereyra - Andrés Arzich</td><td className="px-4 py-2 border">Suprareciclado en Vidrio</td><td className="px-4 py-2 border">X</td><td className="px-4 py-2 border">X</td><td className="px-4 py-2 border">X</td><td className="px-4 py-2 border">X</td></tr>
                  ...
                  <tr><td className="px-4 py-2 border">28</td><td className="px-4 py-2 border">Claudia Golzman - Karina del Savio</td><td className="px-4 py-2 border">Conferencia artistas del vidrio</td><td className="px-4 py-2 border"></td><td className="px-4 py-2 border"></td><td className="px-4 py-2 border">X</td><td className="px-4 py-2 border"></td></tr>
